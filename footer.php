          ...
          <div class="col-md-4 w3l-footer">
            <h2 class="mb-sm-3 mb-2">
              <a href="index.php" class="text-white font-italic font-weight-bold">
                <span>RED_RIVER_ALLIANCE</span>
                <i class="fas fa-syringe ml-2"></i>
              </a>
            </h2>
            <p>Blood donation is a selfless act where individuals voluntarily give their blood to help patients in need. It plays a vital role in healthcare by saving lives during emergencies, surgeries, and for those suffering from chronic illnesses.</p>
          </div>
...
{ ?>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="copy-right-grids mt-lg-1">© RED_RIVER_ALLIANCE
